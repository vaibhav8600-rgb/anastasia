...
# labels, then try each camera in turn, waiting out the exposure ramp on each
# (real webcams need seconds before they stop returning a grey frame).
CAMERA_TIMEOUT_S = 35.0
